package com.forlost.zhongtuo.helper.httphelper;
...
import com.forlost.zhongtuo.model.httpModel.DtdBaseResponseModel;
...
public class DtdHttpHelper {
     ...
     */
    public void regist(String email, String code, String nickname, String password, final DtdHttpCallback<Void> dtdHttpCallback) {
        ...
        Request request = new Request.Builder()
                .url(DTD_API_HTTP_URL + "pub.user/signup")
                .headers(headers)
                .post(formBody)
                .build();
    ...
    public void login(final String username, String password, final DtdHttpCallback<Void> dtdHttpCallback) {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                SecuredPreferenceHelper.getInstance().getSharedPreferences().edit().putString(Config.DTD_USER_TOKEN_KEY, accessToken).apply();
                doSuccess(dtdHttpCallback, null);
            }
        });
    }
    ...
    public <T> void doPost(String pathUrl, JsonObject jsonObject, final Class<T> clazz, final DtdHttpCallback<T> dtdHttpCallback) {
        ...
        Headers headers = new Headers.Builder()
                ...
                .add("authorization", "Bearer " + SecuredPreferenceHelper.getInstance().getSharedPreferences().getString(Config.DTD_USER_TOKEN_KEY, ""))
                .build();
        Request request = new Request.Builder()
