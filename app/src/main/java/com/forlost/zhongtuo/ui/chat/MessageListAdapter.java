...
import static com.forlost.zhongtuo.conf.Config.MESSAGE_TYPE_IMAGE;
...
public class MessageListAdapter extends PagedListAdapter<Message, MessageListAdapter.MessageViewHolder> {
    ...
    protected MessageListAdapter(Context context) {
        ...
        uid = SecuredPreferenceHelper.getInstance().getSharedPreferences().getInt(Config.DTD_USER_UID_KEY, 0);
